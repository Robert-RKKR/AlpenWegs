...
class BaseResponsePagination(PageNumberPagination):
    ...
    def get_paginated_response(self, data):
        """
        Get the paginated response with metadata including the
        paginated data, total number of objects, page count,
        and links to next and previous pages.
        """
        ...
        return Response({
            ...
            'page_count': math.ceil(
                self.page.paginator.count/self.get_page_sizes()),
            'page_links': {
