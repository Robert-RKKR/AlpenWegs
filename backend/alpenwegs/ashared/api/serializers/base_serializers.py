# AlpenWegs import:
from alpenwegs.ashared.helper.filters import dict_to_filter_params
...
class WritableNestedSerializer(
    ...
    def to_internal_value(self, data):
        ...
        Raises:
            ValidationError: If conversion fails or
        ...
        if isinstance(data, dict):
            ...
            # Try to collect object based on provided filters parameters:
            try:
...
class SerializedPkRelatedField(
    ...
    def __init__(self, serializer, **kwargs):
        ...
        # Store the serializer and primary key field information:
