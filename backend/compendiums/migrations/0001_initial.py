    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', django.contrib.gis.db.models.fields.PointField(blank=True, geography=True, help_text='Stores the precise geolocation of the PoI using a PostGIS point.', null=True, srid=4326, verbose_name='Geographic Position (WGS84)')),
