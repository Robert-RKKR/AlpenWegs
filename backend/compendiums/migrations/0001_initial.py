    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('change_own_cardmodel', 'Can change own cards'), ('change_all_cardmodel', 'Can change all cards'), ('delete_own_cardmodel', 'Can delete own cards'), ('delete_all_cardmodel', 'Can delete all cards'), ('view_own_cardmodel', 'Can view own cards'), ('view_all_cardmodel', 'Can view all cards'), ('add_own_cardmodel', 'Can add own cards')],
                'default_permissions': (),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.IntegerField(choices=[(1, 'Peak'), (2, 'Range'), (3, 'Hut'), (4, 'Route'), (5, 'Bridge'), (6, 'Pass'), (7, 'Trail'), (8, 'Lake'), (9, 'Cave'), (10, 'Ruins'), (11, 'Glacier'), (12, 'Cable Car Station'), (21, 'City'), (22, 'Village'), (23, 'Train Station'), (24, 'Parking Space'), (25, 'Restaurant'), (26, 'Bar'), (27, 'Accommodation'), (28, 'Tourist Information'), (41, 'Gemeinde'), (42, 'Canton'), (99, 'Other')], default=99, help_text='Classification of this Point of Interest (e.g. City, Village, Hut, Peak, Lake, Pass).', verbose_name='Category')),
            ],
            options={
                'verbose_name': 'Point of Interest',
                'verbose_name_plural': 'Points of Interest',
                'permissions': [('change_own_poimodel', 'Can change own pois'), ('change_all_poimodel', 'Can change all pois'), ('delete_own_poimodel', 'Can delete own pois'), ('delete_all_poimodel', 'Can delete all pois'), ('view_own_poimodel', 'Can view own pois'), ('view_all_poimodel', 'Can view all pois'), ('add_own_poimodel', 'Can add own pois')],
                'default_permissions': (),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('change_own_regionmodel', 'Can change own regions'), ('change_all_regionmodel', 'Can change all regions'), ('delete_own_regionmodel', 'Can delete own regions'), ('delete_all_regionmodel', 'Can delete all regions'), ('view_own_regionmodel', 'Can view own regions'), ('view_all_regionmodel', 'Can view all regions'), ('add_own_regionmodel', 'Can add own regions')],
                'default_permissions': (),
            },
        ),
    ]
