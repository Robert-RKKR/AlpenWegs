    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_public', models.BooleanField(default=True, help_text='Indicates whether the object is publicly accessible (True) or private (False). If set to True, the object will be visible to all users and guests.', verbose_name='Is Public')),
                ('like_count', models.BigIntegerField(default=0, help_text='Total number of likes this %(class)s has received. This field is used for faster queries and should be synchronized with `users_liked` relations between Model and UserModel.', verbose_name='Like Count')),
                ('geojson', models.JSONField(blank=True, help_text='GeoJSON representation of the route path. Created based on provided GPX file.', null=True, verbose_name='Route GeoJSON Data')),
                ('duration', models.FloatField(blank=True, help_text="User estimated total time required to complete the route, measured in hours. This estimate considers the user's predicted hiking pace along with elevation changes but may still be influenced by factors such as weather conditions and trail difficulty.", null=True, verbose_name='Estimated Duration')),
                ('distance', models.FloatField(blank=True, help_text='The total length of the route, measured in kilometres. This includes the full distance from start to finish, including both flat and uphill sections.', null=True, verbose_name='Route Distance')),
                ...
                ('highest_elevation', models.FloatField(blank=True, help_text='Maximum altitude reached along the route, measured in meters above sea level.', null=True, verbose_name='Highest Elevation')),
                ('lowest_elevation', models.FloatField(blank=True, help_text='Minimum altitude encountered along the route, measured in meters above sea level.', null=True, verbose_name='Lowest Elevation')),
