    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(blank=True, help_text='The member responsible for the change. This field links to the member who performed the action, providing accountability and traceability.', null=True, on_delete=django.db.models.deletion.PROTECT, to='profiles.membermodel', verbose_name='Member')),
            ],
            options={
                'verbose_name': 'Change',
