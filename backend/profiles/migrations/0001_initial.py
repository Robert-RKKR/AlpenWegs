    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('change_own_usermodel', 'Can change own users'), ('change_all_usermodel', 'Can change all users'), ('delete_own_usermodel', 'Can delete own users'), ('delete_all_usermodel', 'Can delete all users'), ('view_own_usermodel', 'Can view own users'), ('view_all_usermodel', 'Can view all users'), ('add_own_usermodel', 'Can add own users')],
            },
        ),
        migrations.CreateModel(
