    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(django.db.models.functions.text.Lower('email'), name='uniq_user_email_lower'), models.CheckConstraint(condition=models.Q(('height__isnull', True), ('height__gt', 0), _connector='OR'), name='height_gt_zero_or_null'), models.CheckConstraint(condition=models.Q(('weight__isnull', True), ('weight__gt', 0), _connector='OR'), name='weight_gt_zero_or_null')],
            },
        ),
    ]
